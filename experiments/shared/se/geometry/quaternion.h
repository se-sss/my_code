  ...
  namespace geometry
  {
    ...
    private:
      ...
      public:typedef T value_type;
        ...
        friend quaternion < Q > operator*(const P k,
                                          const quaternion < Q > &q);

        template < typename P, typename Q >
        friend quaternion < Q > operator*(const quaternion < Q > &q,
                                          const P k);

        template < typename P >
        friend quaternion < P > operator*(const quaternion < P > &q,
                                          const v3d < P > &vec);

        template < typename P >
        friend quaternion < P > operator*(const v3d < P > &vec,
                                          const quaternion < P > &q);

        template < typename P >
        friend quaternion < P > operator*(const quaternion < P > &q1,
                                          const quaternion < P > &q2);
      ...
      quaternion(const T real_part):r(real_part)
      {
      }

      quaternion(const v3d < T > &vector_part):r(), v(vector_part)
      {
      }

      quaternion(const T & real_part,
                 const v3d < T > &vector_part):r(real_part), v(vector_part)
      {
      }
      ...
      quaternion(const T & a, const T & b, const T & c, const T & d):r(a),
        v(b, c, d)
      {
      }
      ...
      template < typename P > quaternion & operator*=(const P & k)
      {
        r *= k;
        v *= k;
        return *this;
...
//      template<>
    ...
    template < typename P >
      quaternion < P > operator*(const quaternion < P > &q,
                                 const v3d < P > &vec)
    {
    ...
    template < typename P >
      quaternion < P > operator*(const v3d < P > &vec,
                                 const quaternion < P > &q)
    {
      return quaternion < P > (-(q.v, vec), q.r * vec + (q.v ^ vec));
    }
    ...
    template < typename P >
      quaternion < P > operator*(const quaternion < P > &q1,
                                 const quaternion < P > &q2)
    {
